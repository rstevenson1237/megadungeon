...
export const ITEMS = {
  ...
  mace:         { key: 'mace',         name: 'Mace',           category: 'weapon',  glyph: 0x5C, color: '#888888', weight: 6, value: 12, stackable: false, weapon: { damage: [1,6], attackBonus: 0, damageMod: 0, range: 1, twoHanded: false }, description: 'A flanged head on a stout shaft.' },
  ...
  chain_mail: {
    ...
    glyph: 0x5B, color: '#888888', weight: 15, value: 75, stackable: false,
    armor: { acBonus: 4, slot: 'body', maxDexBonus: 3 },
    description: 'Interlocking iron rings. Deflects blades well, rattles conspicuously.',
  },
  leather_armor:{ key: 'leather_armor',name: 'Leather Armor',  category: 'armor',   glyph: 0x5B, color: '#885533', weight: 8,  value: 20,  stackable: false, armor: { acBonus: 2, slot: 'body', maxDexBonus: 6 }, description: 'Hardened leather.' },
  plate_mail:   { key: 'plate_mail',   name: 'Plate Mail',     category: 'armor',   glyph: 0x5B, color: '#cccccc', weight: 25, value: 400, stackable: false, armor: { acBonus: 6, slot: 'body', maxDexBonus: 1 }, description: 'Full plate armor.' },
  ...
  spellbook:    { key: 'spellbook',    name: 'Spellbook',      category: 'tool',    glyph: 0x2B, color: '#8844cc', weight: 3, value: 50, stackable: false, description: 'A leather-bound book of arcane formulae.' },
  ...
  arrows_20:    { key: 'arrows_20',    name: '20 Arrows',      category: 'tool',    glyph: 0x18, color: '#885533', weight: 2, value: 5,  stackable: true,  description: 'A quiver of wooden arrows.' },
  ...
  ring_of_protection: {
    ...
    category: 'ring', glyph: 0x3D, color: '#ffcc44', weight: 0, value: 1000, stackable: false,
  ...
  amulet_of_life_protection: {
    ...
    category: 'amulet', glyph: 0x22, color: '#ffcc88', weight: 0, value: 5000, stackable: false,
  ...
  crude_dagger: {
    ...
    glyph: 0x2D, color: '#886644', weight: 1, value: 1, stackable: false,
  ...
  war_axe: {
    ...
    glyph: 0x29, color: '#aaaaaa', weight: 7, value: 30, stackable: false,
  ...
  forge_hammer: {
    ...
    glyph: 0x29, color: '#886644', weight: 9, value: 20, stackable: false,
  ...
  phase_blade: {
    ...
    glyph: 0x29, color: '#aa44ff', weight: 3, value: 800, stackable: false,
  ...
  embalming_kit: {
    ...
    glyph: 0x7E, color: '#aa8866', weight: 4, value: 15, stackable: false,
    description: 'Jars of preserving salts and lengths of linen wrapping.',
  },
  runic_chisel: {
    key: 'runic_chisel', name: 'Runic Chisel', category: 'tool',
    glyph: 0x7E, color: '#aaaacc', weight: 2, value: 40, stackable: false,
  ...
  prismatic_flask: {
    ...
    glyph: 0x2A, color: '#ffaaff', weight: 1, value: 180, stackable: false,
  ...
  bone_wand: {
    ...
    category: 'wand', glyph: 0x5C, color: '#ccaa88', weight: 1, value: 150, stackable: false,
  ...
  mead_skin: {
    ...
    glyph: 0x21, color: '#ffcc44', weight: 2, value: 8, stackable: true,
  ...
  unholy_water: {
    ...
    glyph: 0x21, color: '#884488', weight: 1, value: 20, stackable: true,
  ...
  dwarven_ale: {
    ...
    glyph: 0x25, color: '#aa6622', weight: 2, value: 5, stackable: true,
    food: { nutrition: 200 },
  ...
  dwarven_bread: {
    ...
    glyph: 0x25, color: '#aa8844', weight: 3, value: 3, stackable: true,
    food: { nutrition: 600 },
  ...
  old_scroll: {
    ...
    category: 'scroll', glyph: 0x3F, color: '#ccbb88', weight: 0, value: 10, stackable: false,
    scroll: { spellKey: 'magic_missile', casterLevel: 1 },
  ...
  scroll_of_turning: {
    ...
    category: 'scroll', glyph: 0x3F, color: '#ffff88', weight: 0, value: 80, stackable: false,
  ...
  rift_scroll: {
    ...
    category: 'scroll', glyph: 0x3F, color: '#aa44ff', weight: 0, value: 250, stackable: false,
  ...
  storm_rune: {
    ...
    category: 'scroll', glyph: 0x3F, color: '#ffff44', weight: 1, value: 200, stackable: false,
  ...
  iron_key: {
    ...
    glyph: 0x6B, color: '#888888', weight: 0, value: 5, stackable: false,
    description: 'A heavy iron key. Opens standard dungeon locks.',
  },
  dimensional_key: {
    key: 'dimensional_key', name: 'Dimensional Key', category: 'tool',
    glyph: 0x6B, color: '#aa44ff', weight: 0, value: 500, stackable: false,
  ...
  wand_of_magic_missile: {
    ...
    category: 'wand', glyph: 0x5C, color: '#aaaaff', weight: 1, value: 300, stackable: false,
  ...
  wand_of_frost: {
    ...
    category: 'wand', glyph: 0x5C, color: '#88ccff', weight: 1, value: 400, stackable: false,
  ...
  wand_of_fear: {
    ...
    category: 'wand', glyph: 0x5C, color: '#884444', weight: 1, value: 350, stackable: false,
  ...
  wand_of_healing: {
    ...
    category: 'wand', glyph: 0x5C, color: '#88ff88', weight: 1, value: 500, stackable: false,
  ...
  wand_of_lightning: {
    ...
    category: 'wand', glyph: 0x5C, color: '#ffff44', weight: 1, value: 600, stackable: false,
  ...
  potion_of_strength: {
    ...
    glyph: 0x21, color: '#ff8844', weight: 1, value: 150, stackable: true,
  ...
  potion_of_invisibility: {
    ...
    glyph: 0x21, color: '#ccffff', weight: 1, value: 300, stackable: true,
  ...
  antidote: {
    ...
    glyph: 0x21, color: '#44ff88', weight: 1, value: 75, stackable: true,
  ...
  potion_of_fire_resist: {
    ...
    glyph: 0x21, color: '#ff6622', weight: 1, value: 200, stackable: true,
  ...
  scroll_of_fireball: {
    ...
    category: 'scroll', glyph: 0x3F, color: '#ff4422', weight: 0, value: 120, stackable: false,
  ...
  scroll_of_sleep: {
    ...
    category: 'scroll', glyph: 0x3F, color: '#8888ff', weight: 0, value: 80, stackable: false,
  ...
  scroll_of_detect_traps: {
    ...
    category: 'scroll', glyph: 0x3F, color: '#ffcc44', weight: 0, value: 50, stackable: false,
  ...
  scroll_of_teleport: {
    ...
    category: 'scroll', glyph: 0x3F, color: '#44aaff', weight: 0, value: 300, stackable: false,
  ...
  great_sword: {
    ...
    glyph: 0x29, color: '#cccccc', weight: 8, value: 50, stackable: false,
  ...
  hand_crossbow: {
    ...
    glyph: 0x29, color: '#885533', weight: 3, value: 45, stackable: false,
  ...
  studded_leather: {
    ...
    glyph: 0x5B, color: '#aa7744', weight: 10, value: 45, stackable: false,
  ...
  half_plate: {
    ...
    glyph: 0x5B, color: '#aaaacc', weight: 20, value: 200, stackable: false,
  ...
  iron_helm: {
    ...
    glyph: 0x5B, color: '#888888', weight: 3, value: 20, stackable: false,
  ...
  great_helm: {
    ...
    glyph: 0x5B, color: '#aaaaaa', weight: 5, value: 60, stackable: false,
